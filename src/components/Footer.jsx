  ...
  return (
    <div className='bg-black px-5 lg:px-28 py-3 lg:py-6 flex items-center justify-between mt-16'>
      <div className="flex items-center gap-2">
        <img className='invert h-5 lg:h-9' src="/assets/ds-logo.png" alt="DS Logo" />
        <span className="font-extrabold text-white text-sm lg:text-lg tracking-wide font-sora">Divyansh</span>
      </div>
